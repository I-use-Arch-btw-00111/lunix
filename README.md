...
If you see the word "LILO" or "GRUB" during your windows startup (just after you turn the machine on), your son has installed lunix. In order to get rid of it, you will have to send your computer back to the manufacturer, and have them replace the hard drive, possibly mobo and surely its bios. Lunix is extremely dangerous software, and cannot be removed without destroying these components of your machine. 
```

- **Is Your Son A Computer Hacker?**
If you want to make sure whether your son is or is not a hacker, you can watch this tutorial to learn how to check it: https://www.youtube.com/watch?v=LLFhKaqnWwk
